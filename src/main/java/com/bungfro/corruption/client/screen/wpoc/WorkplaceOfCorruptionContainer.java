...
public class WorkplaceOfCorruptionContainer implements Container, StackedContentsCompatible {
    private final NonNullList<ItemStack> items;
    private final int width;
    private final int height;
    private final AbstractContainerMenu menu;

    public WorkplaceOfCorruptionContainer(AbstractContainerMenu pMenu, int pWidth, int pHeight) {
