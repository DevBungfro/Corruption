...
public class WorkplaceOfCorruptionResultSlot extends Slot {
    private final WorkplaceOfCorruptionContainer craftSlots;
    private final Player player;
    private int removeCount;

    public WorkplaceOfCorruptionResultSlot(Player pPlayer, WorkplaceOfCorruptionContainer pCraftSlots, Container pContainer, int pSlot, int pXPosition, int pYPosition) {
